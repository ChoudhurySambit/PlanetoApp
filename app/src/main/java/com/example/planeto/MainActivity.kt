...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var planetsData:ArrayList<PlanetData>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val planetNames= arrayOf(
            "Moon","Mercury","Venus",
            "Earth","Mars","Jupiter","Saturn","Uranus","Neptune","Sun"
        )
        val imageOfPlanets= arrayOf(
            R.drawable.ic_moon,R.drawable.ic_mercury,R.drawable.ic_venus,R.drawable.ic_earth,R.drawable.ic_mars,R.drawable.ic_jupiter,R.drawable.ic_saturn,R.drawable.ic_uranus,R.drawable.ic_neptune,R.drawable.ic_sun)

        val galaxyNames= arrayOf(
            "MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy"
            ,"MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy","MilkyWay Galaxy"
        )

        val planetDistance= arrayOf(
            "150.0", "57.9", "108.2","149.6","227.9", "778.3","1427.0", "2871.0", "4497.1","0"
        )

        val planetGravity= arrayOf(
            "1.62", "3.7", "8.87","9.807","3.721", "24.79", "10.44", "8.87", "11.15", "274.0"
        )

        val planetOverView=arrayOf(
        ...
        planetsData=ArrayList<PlanetData>()

        for(index in planetNames.indices){

            var planet=PlanetData(planetNames[index], imageOfPlanets[index],galaxyNames[index],planetDistance[index],planetGravity[index],planetOverView[index])

            planetsData.add(planet)

        }
        myRecyclerView=findViewById<RecyclerView>(R.id.planetRecyclerView)
        myRecyclerView.layoutManager=LinearLayoutManager(this)
        myRecyclerView.adapter=myAdapter(planetsData)
